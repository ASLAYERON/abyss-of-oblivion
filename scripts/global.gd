...
func reset_enemies():#recerée tout les ennemis a chaque repos, est appelé par checkpoint
	enemies={
		"caves":{
			...
			"rat02":["rat",Vector2(1120,552)],
			"rat03":["rat",Vector2(1223,528)],
			"rat04":["rat",Vector2(1223,528)],
			"rat05":["rat",Vector2(1223,528)],
			"rat06":["rat",Vector2(1223,528)],
			"rat07":["rat",Vector2(1223,528)],
			"rat08":["rat",Vector2(1223,528)],
			"rat09":["rat",Vector2(1223,528)],
			"rat10":["rat",Vector2(1223,528)],
			"rat11":["rat",Vector2(1223,528)],
			"rat12":["rat",Vector2(1223,528)],
			"rat13":["rat",Vector2(1223,528)],
			"rat14":["rat",Vector2(1223,528)],
		},
		"mines":{
